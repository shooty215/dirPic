...
APP_JSON_PROPERTIES_NAME="als.json"
APP_JSON_ALS_PATH=$APP_KEYSTORE_DIRECTORY$APP_JSON_PROPERTIES_NAME
...
$JAVA -jar $APP_BINARY_SUBSCRIBER $APP_JSON_PROPERTIES_PATH $APP_JSON_ALS_PATH\n
"
...
$JAVA -jar $APP_BINARY_PUBLISHER $APP_JSON_PROPERTIES_PATH $APP_JSON_ALS_PATH\n
"
...
$SUDO $COPY $APP_BINARY_SUBSCRIBER_SERVICE $SERVICE_FILES_DIRECTORY"dirpicsubscriber.service"
$SUDO $COPY $APP_BINARY_PUBLISHER_SERVICE $SERVICE_FILES_DIRECTORY"dirpicpublisher.service"

# copy pem files to their destination
$SUDO $COPY bin/deployables/caCrt.pem $APP_KEYSTORE_DIRECTORY"tls_ca_crt.pem"
