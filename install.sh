...
APP_BINARY_SUBSCRIBER=$APP_BINARY_DIRECTORY"startDirPicSubscriber.jar"
APP_BINARY_PUBLISHER=$APP_BINARY_DIRECTORY"startDirPicPublisher.jar"
...
#!/bin/bash\n
/usr/bin/java -jar "$APP_BINARY_PUBLISHER" "$BROKER_PORT" "$BROKER_CHANNEL" "$APP_CAMERA_DIRECTORY" "$APP_KEYSTORE_DIRECTORY" "$BROKER_USER" "$BROKER_USER_PASSWORD"
"
APP_BINARY_PUBLISHER_START_SCRIPT="
#!/bin/bash\n
/usr/bin/java -jar "$APP_BINARY_SUBSCRIBER" "$BROKER_PORT" "$BROKER_CHANNEL" "$APP_STORAGE_DIRECTORY" "$APP_KEYSTORE_DIRECTORY" "$BROKER_USER" "$BROKER_USER_PASSWORD"
"
...
/usr/bin/sudo echo $APP_USER_PASSWORD_PLAIN_TEXT > $APP_USER_HOME_DIRECTORY'encrypt'